...
@WebServlet("/CustomerApproveQuoteServlet")
public class CustomerApproveQuoteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	protected void doGet(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {

		String orderId = request.getParameter("orderIdProducts");
		CustomerService cservice = new CustomerServiceImpl();
		cservice.changeQuoteStatus(orderId);
