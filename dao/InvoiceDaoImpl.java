...
public class InvoiceDaoImpl implements InvoiceDao {
	...
	public List<Object> displayOrderInvoice(String orderId) {
		...
		try {
			...
			invoice.add(new Order(rs.getString(7), rs.getDate(8), rs.getFloat(9), rs.getFloat(10), rs.getString(11)));
			invoice.add(new Customer(rs.getString(12), rs.getString(13), rs.getString(14), rs.getString(15), rs.getString(16), rs.getString(17), rs.getString(18)));
