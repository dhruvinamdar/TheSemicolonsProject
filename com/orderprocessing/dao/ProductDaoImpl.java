...
import com.orderprocessing.entity.ProductsInsertionStatus.Status;
...
public class ProductDaoImpl implements ProductDao {
	...
	// private final static String INSERT_PRODUCT = "Replace into product values
	// (?,?,?,?)";
	...
	public String getAllProduct() {
		...
		try {
			...
			System.out.println(productArrayToJson);
...
//				stmt.setString(1, product.getProductId());
			...
			productsInsertionStatus.setStatus(Status.completed);
