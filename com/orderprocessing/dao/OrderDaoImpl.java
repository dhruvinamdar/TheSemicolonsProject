...
public class OrderDaoImpl implements OrderDao{
	...
	public List<Order> getOrders() throws NoOrderFoundException{
		...
		try
		{
			...
			if(resultSet.next())
			{
				orderList.add(new Order(resultSet.getString(1),resultSet.getDate(2),resultSet.getString(3),resultSet.getFloat(4),resultSet.getFloat(5),resultSet.getString(6),resultSet.getString(7)));
			}
		}
