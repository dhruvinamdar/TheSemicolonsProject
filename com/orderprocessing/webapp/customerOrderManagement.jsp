  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary bs-side-navbar">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <button class="nav-link" style="background:none; border:none" onclick="showQuoteForm()">List Of Quotes</a>
            </li>
            <li class="nav-item">
                <button class="nav-link" style="background:none; border:none" onclick="showOrderForm()">List Of Orders</button>
            </li>
            <li class="nav-item">
  ...
  <div class="customer" id="customer">
  	<form class="newQuote" id="newQuote" action="CustomerViewDetailedQuoteServlet" method="get">
  		...
  		<div class="form-group row">
            ...
            <button type="button" class="btn btn-primary" onclick="showCustomerQuote(event)" id="showOrders">Show Quotes</button>
     </form>
  ...
  <div class="customerOrders" id="customerOrders" style="display:none">
  	<form class="newQuote" id="newQuote" action="CustomerViewInvoiceServlet" method="get">
  		<div class="form-group row">
            ...
            <button type="button" class="btn btn-primary" id="orderList" onclick="showListOfOrders(event)">Show Orders</button>
     </form>
