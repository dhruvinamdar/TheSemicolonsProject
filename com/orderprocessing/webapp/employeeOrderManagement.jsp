          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              ...
              <form action="importProductsBase" method="post">
                <button class="nav-link" id="importBtn" style="border:none; background:none" >Import Products</button>
              </form>
              </li>
              <li class="nav-item">
      ...
      <div class="employee" >
        <form class="newQuote" id="quoteForm">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10" >
            <input type="text" class="form-control" id="customerId" placeholder="Enter Customer Id or Name" required>
            </div>
          </div>
            ...
            <div id="products"></div>
            <button type="submit" class="btn btn-primary" onclick="showProductTable(event)" id="submitcustomer">Submit</button>
            <button type="submit" class="btn btn-primary" id="submitQuote" style="display:none" onclick="createQuote(event)"> Generate Quote </button>
          </form>
        </div>
    </div>
