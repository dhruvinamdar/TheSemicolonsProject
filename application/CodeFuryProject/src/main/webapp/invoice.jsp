                    ...
                    <div class="col-8">
                        <form class="productForm" action="" method="post">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="" class="form-control" id="invoiceId"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="invoiceDate"
                                        value="${invoice.invoiceDate}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="totalGSTAmount" class="col-sm-2 col-form-label">Total GST Amount</label>
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="totalGSTAmount"
                                        value="${invoice.totalGstAmount}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="totalInvoiceValue" class="col-sm-2 col-form-label">Total Invoice
                                    Value</label>
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="totalInvoiceValue"
                                        value="${invoice.totalInvoiceValue}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="invoiceStatus" class="col-sm-2 col-form-label">Invoice Status</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="invoiceStatus"
                                        value="${invoice.invoiceStatus}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="orderId"
                                        value="${invoice.orders.orderId}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="orderDate"
                                        value="${invoice.orders.orderDate }" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="totalOrderValue" class="col-sm-2 col-form-label">Total Order Value</label>
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="totalOrderValue"
                                        value="${invoice.orders.totalOrderValue}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="shippingCost"
                                        value="${invoice.orders.shippingCost}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="shippingAgency" class="col-sm-2 col-form-label">Shipping Agency</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="shippingAgency"
                                        value="${invoice.orders.shippingAgency}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="customerName"
                                        value="${invoice.customer.customerName}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="customerAddress"
                                        value="${invoice.customer.customerAddress}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="customerCity"
                                        value="${invoice.customer.customerCity}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="customerState"
                                        value="${invoice.customer.customerState}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="customerEmail"
                                        value="${invoice.customer.customerEmail}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="customerPincode"
                                        value="${invoice.customer.customerPincode}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="customerContact"
                                        value="${invoice.customer.customerContact}" readonly>
                                </div>
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary" onclick="javascript:window.print();">Print
                                PDF</button>
                        </form>
                    </div>
